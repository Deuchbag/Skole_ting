...
var parAntall1 = false
var parAntall2 = false
var parAntall3 = false
var parAntall4 = false
var parVerdi1 =0;
var parVerdi2 =0;
var parVerdi3 =0;
var parVerdi4 =0;
//Denne fungerer halveis,men den har et problem hvor den ikke alltid legger inn svaret. Er ikke helt sikker på hva som er galt.
function par2(){
    resetTerning()
    parAntall = 0;
    if(terningside1 == terningside2 || terningside1 == terningside3 || terningside1 == terningside4 || terningside1 == terningside5){
        parAntall1 = true
        parVerdi1 = terningside1 * 2;
    }
    if(terningside2 == terningside3 || terningside2 == terningside4 || terningside2 == terningside5){
        parAntall2 = true
        parVerdi2 = terningside2 * 2;
    }
    if(terningside3 == terningside4 || terningside3 == terningside5){
        parAntall3 = true
        parVerdi3 = terningside3 * 2;
    }
    if(terningside4 == terningside5){
        parAntall4 = true
        parVerdi4 = terningside4 * 2;
    }
    ...
    if(parAntall1 == true && parAntall2 == true) {
        parAntall = parVerdi1 + parVerdi2;
    }
    else if(parAntall1 == true && parAntall3 ==true){
        parAntall = parVerdi1 + parVerdi3
    }

    else if(parAntall1 == true && parAntall4 == true){
        parAntall = parVerdi1 + parVerdi4
    }
    else if(parAntall2 == true && parAntall3 == true) {
        parAntall = parVerdi2 + parAntall3;
    }
    else if(parAntall2 == true && parAntall4 == true){
        parAntall = parVerdi2 + parVerdi4
    }
    else if(parAntall3 == true && parAntall4 == true){
        parAntall = parVerdi3 + parVerdi4
    }
    aktuelTag[9][runde-1].innerHTML = parAntall;
}
